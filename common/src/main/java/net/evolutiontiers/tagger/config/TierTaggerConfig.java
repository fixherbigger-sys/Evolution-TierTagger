...
public class TierTaggerConfig implements Serializable {
    ...
    private int retiredColor = 0xB33A3A; // brand dark red, distinct from every HT/LT tier color below
     ...
     */
    private String apiUrl = "https://api.evolutiontiers.dpdns.org";
    ...
    public enum HighestMode implements StringTranslatable {
        NEVER("never", "evolutiontiers.highest.never"),
        NOT_FOUND("not_found", "evolutiontiers.highest.not_found"),
        ALWAYS("always", "evolutiontiers.highest.always"),
        ;
